...
router.post('/payment-methods', createPaymentMethodValidator, PaymentMethodController.createPaymentMethod);
...
router.put('/payment-methods/:id', updatePaymentMethodValidator, PaymentMethodController.updatePaymentMethod);
router.delete('/payment-methods/:id', deletePaymentMethodValidator, PaymentMethodController.deletePaymentMethod);
